    ...
    , ITypeIdentityProvider
{
    ...
    /// <summary>
    /// Parses a directive node with variable context.
    /// </summary>
    /// <param name="directiveNode">The directive node to parse.</param>
    /// <param name="context">The middleware context containing variable values.</param>
    /// <returns>The parsed directive value.</returns>
